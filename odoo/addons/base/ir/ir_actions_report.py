...
try:
    ...
    _logger.info('Você precisa do Wkhtmltopdf para imprimir uma versão em pdf dos relatórios.')
else:
    _logger.info('Usará o binário Wkhtmltopdf em %s' % _get_wkhtmltopdf_bin())
    ...
    if match:
        ...
        if config['workers'] == 1:
            _logger.info('Você precisa iniciar o sistema com pelo menos dois funcionários para imprimir uma versão em pdf dos relatórios.')
