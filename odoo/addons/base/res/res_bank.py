...
class ResPartnerBank(models.Model):
    ...
    partner_id = fields.Many2one('res.partner', 'Titular da conta', ondelete='cascade', index=True, domain=['|', ('is_company', '=', True), ('parent_id', '=', False)], default=lambda self: self.env.user.company_id.partner_id)
