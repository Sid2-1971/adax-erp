...
class Planner(models.Model):
    ...
    active = fields.Boolean(string="Active", default=False, help="If the active field is set to False, it will allow you to hide the planner. This change requires a refresh of your page.")
