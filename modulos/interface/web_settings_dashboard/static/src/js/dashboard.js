...
var DashboardShare = Widget.extend({
    ...
    init: function(parent, data){
        this.data = data;
        this.parent = parent;
        this.share_url = 'https://www.adaxtechnology.com';
        this.share_text = encodeURIComponent("Usamos os serviços da ADAX Technology - Soluções em Gestão Corporativa | Soluções Geoespaciais | Soluções em Infraestrutura de TI.");
    },
    ...
    share_linkedin: function(){
        var popup_url = _.str.sprintf('http://www.linkedin.com/shareArticle?mini=true&url=%s&title=Usamos os serviços da ADAX Technology&summary=%s&source=www.adaxtechnology.com', encodeURIComponent(this.share_url), this.share_text);
        this.sharer(popup_url);
    },
