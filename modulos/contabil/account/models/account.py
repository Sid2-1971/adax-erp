...
class AccountJournal(models.Model):
    ...
    bank_account_id = fields.Many2one('res.partner.bank', string="Conta Bancária", ondelete='restrict', copy=False)
    bank_statements_source = fields.Selection([('undefined', 'Undefined Yet'),('manual', 'Record Manually')], string='Retornos Bancários', default='undefined')
