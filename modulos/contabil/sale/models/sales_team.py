...
class CrmTeam(models.Model):
    ...
    use_invoices = fields.Boolean('Definir meta de faturamento', help="Marque esta caixa para definir uma meta de faturamento para este canal de vendas.")
    ...
    invoiced_target = fields.Integer(
        string='Meta de faturamento',
        help="Segmentação da receita da fatura do mês atual. Essa é a quantia que as vendas "
             "estimativas de canal para poder faturar este mês.")
