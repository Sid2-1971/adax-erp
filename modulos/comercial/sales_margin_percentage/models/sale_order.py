...
class SaleOrder(models.Model):
    ...
    margin_percentage = fields.Char(compute='_get_average_margin_percentage', string='% de Margem')
...
class SaleOrderLine(models.Model):
    ...
    margin_percentage = fields.Char(compute='_get_total_percentage', string='% de Margem')
